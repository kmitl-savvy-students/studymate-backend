...
{
    // private const bool ALLOW_UPLOAD_SOMEONE_TRANSCRIPT = true; // DEFAULT : FALSE
    // private const bool ALLOW_UPLOAD_NOT_SIGNUP_USER_TRANSCRIPT = true; // DEFAULT : FALSE
    //
    ...
    //     if (!ALLOW_UPLOAD_NOT_SIGNUP_USER_TRANSCRIPT && user == null)
    //         return new BaseResponse(EnumResponseCode.NOT_FOUND, "ระบบพบว่านี่ไม่ใช่ Transcript ของผู้ใช้ในระบบ");
    //
    //     // Check if user matches
    //     if (!ALLOW_UPLOAD_SOMEONE_TRANSCRIPT && user.Id != userToken.User.Id)
